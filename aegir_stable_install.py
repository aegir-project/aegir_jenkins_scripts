...
"""Aegir stable release testing script

Valid options:
--aegir_version - The version of Aegir to test (required)
--release_type - Either 'git' or 'package' (required)
...
def main(argv=None):
        ...
        try:
                ...
                if release_type is None:
                        raise Usage, "the --release_type option must be specified"
